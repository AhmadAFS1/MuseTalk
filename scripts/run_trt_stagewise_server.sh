...
: "${WEBRTC_TRIM_EDGE_SILENCE:=1}"
: "${WEBRTC_AUDIO_ACTIVITY_THRESHOLD_DB:=-45}"
: "${WEBRTC_AUDIO_LEADING_PADDING_SECONDS:=0.08}"
: "${WEBRTC_AUDIO_TRAILING_PADDING_SECONDS:=0.04}"
...
export WEBRTC_AUDIO_SYNC_STRATEGY
export WEBRTC_TRIM_EDGE_SILENCE
export WEBRTC_AUDIO_ACTIVITY_THRESHOLD_DB
export WEBRTC_AUDIO_LEADING_PADDING_SECONDS
export WEBRTC_AUDIO_TRAILING_PADDING_SECONDS
...
export WEBRTC_POSE_MAX_SEMANTIC_DRIFT_SECONDS
export WEBRTC_POSE_FORCED_CROSSFADE_FRAMES
...
log "WEBRTC_POSE_MAX_SEMANTIC_DRIFT_SECONDS=$WEBRTC_POSE_MAX_SEMANTIC_DRIFT_SECONDS"
log "WEBRTC_POSE_FORCED_CROSSFADE_FRAMES=$WEBRTC_POSE_FORCED_CROSSFADE_FRAMES"
...
log "WEBRTC_AUDIO_SYNC_STRATEGY=$WEBRTC_AUDIO_SYNC_STRATEGY"
log "WEBRTC_TRIM_EDGE_SILENCE=$WEBRTC_TRIM_EDGE_SILENCE"
log "WEBRTC_AUDIO_ACTIVITY_THRESHOLD_DB=$WEBRTC_AUDIO_ACTIVITY_THRESHOLD_DB"
log "WEBRTC_AUDIO_LEADING_PADDING_SECONDS=$WEBRTC_AUDIO_LEADING_PADDING_SECONDS"
log "WEBRTC_AUDIO_TRAILING_PADDING_SECONDS=$WEBRTC_AUDIO_TRAILING_PADDING_SECONDS"
