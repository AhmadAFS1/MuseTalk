#!/usr/bin/env python3
"""Cadence-neutral comparison of the v4 and v3 four-pose WebRTC showcases."""
...
RUNS = OrderedDict(
    (
        (
            "baseline_v3_15frame_2crossfade_30playback_15lipsync",
            {
                "video": ROOT
                ...
                "ardy_source_boundary_frames": 15,
            },
        ),
        (
            "candidate_v4_30frame_2crossfade_30playback_15lipsync",
            {
                "video": ROOT
                / "generated/webrtc_pose_showcase/2026-07-30/"
                "mvp_four_v4_30frame_boundaries_30playback_15lipsync/"
                "indian_tutor_mvp_four_v4_30frame_30playback_15lipsync_webrtc_capture.mp4",
                "result": ROOT
                / "generated/webrtc_pose_showcase/2026-07-30/"
                "mvp_four_v4_30frame_boundaries_30playback_15lipsync/"
                "webrtc_result.json",
                ...
                "crossfade_frames": 2,
                "asset_generation_fps": 15.0,
                "ardy_source_boundary_frames": 30,
            },
        ),
    )
)
...
def main() -> int:
    ...
    for run_name, paths in RUNS.items():
        ...
        output["runs"][run_name] = {
            ...
            "ardy_source_boundary_frames": paths["ardy_source_boundary_frames"],
            "summary": summarize(event_metrics),
            "events": event_metrics,
        }

    baseline = output["runs"][
        "baseline_v3_15frame_2crossfade_30playback_15lipsync"
    ]
    current = output["runs"][
        "candidate_v4_30frame_2crossfade_30playback_15lipsync"
    ...
    output["v4_vs_v3"] = comparisons

    output_path = OUTPUT_DIR / "v4_vs_v3_cadence_neutral_webrtc_validation.json"
